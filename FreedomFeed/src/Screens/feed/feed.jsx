...
function Feed() {
  ...
  return ( <div className='MainFeed'>
    ...
    <div className='MainScroll'>Scroll</div>
    <div className='MainWidget'>widget</div> 
    </div>
      )
}
